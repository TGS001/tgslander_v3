    ...
    internal sealed class Effect
    {
        ...
        internal void Build(RenderTarget source, RenderTarget destination, Settings settings, CommandBuffer cmd, UnityEngine.Camera renderingCamera)
        {
            ...
            if(_settings.workflow == Workflow.Selective)
            {
                ...
                _selectiveRenderTarget.renderTexture = RenderTexture.GetTemporary(_renderingCamera.pixelWidth / 2, _renderingCamera.pixelHeight / 2, 16, _renderTextureFormat, RenderTextureReadWrite.Default, 1);//PipelineExtensions.GetTemporary(_selectiveRenderContext, _renderTextureFormat);
